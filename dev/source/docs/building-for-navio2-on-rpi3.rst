...
instructions
`here <https://docs.emlid.com/navio2/common/ardupilot/configuring-raspberry-pi/>`__.

Alternatively you can follow Emlid's instructions on how to build from
source found
`here <https://docs.emlid.com/navio2/common/ardupilot/building-from-sources/>`__.
